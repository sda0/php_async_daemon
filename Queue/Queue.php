...
class Queue
{
     ...
     * @todo Проверить - сейчас  убивает невовремя
     */
     ...
     * @return type
     */
    public function msg_receive(int $desiredmsgtype, $callback = null)
    {
        $this->msg_get_queue();
     ...
     * @return type
     */
    public function msg_send(int $msgtype, $message, bool $serialize = true, bool $blocking = true)
    {
        $this->msg_get_queue();
